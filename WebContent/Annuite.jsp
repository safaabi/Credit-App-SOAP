  ...
  <nav class="site-header sticky-top py-1">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
 			...
 			<div class="col-lg-6 mx-auto">
 			     <a class="btn btn-dark active  " id="list-home-list"  href="Annuite.jsp" >Annuité</a>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
              <div class="tab-content" id="pills-tabContent"> 
                  <div>
                       <h2 style ="text-align: center;"  >Calcul de l'annuité</h2>
                  </div>                      
                       ...
                       <form id="formAnnuite" action="AnnuiteServlet" method="POST" class="needs-validation" novalidate>
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    %>
                                        <input type="number" class="form-control" id="inputDuree" name="inputDuree" placeholder="Durée"   value=${dureeResA } min="1" max="12" required>
                                       <%
                                       }else{
                                    %>
                                    ...
                                    <%
							          ...
							          %>
							          <div >
								        <h5 style ="text-align: center;" >Annuité mensuelle = ${annuiteResA }</h5>
							         </div>
